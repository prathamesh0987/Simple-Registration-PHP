<?php
    ...
    $sql ="SELECT * FROM `demoo` where id='$id'";
...
<body>
    ...
    <div class="container">
        ...
        <input type="hidden" name="editfile" value="<?= $row['image'];?>" >
        <input type="hidden" name="action" value="update">
            <h2 class="text-center">Edit  Form</h2>
        <div class="row jumbotron">
            <div class="col-sm-4 form-group">
                <label for="name-f"> Name</label>
                <input type="text" class="form-control" name="name" id="name-f" placeholder="Enter your name." value="<?= $row['name'];?>">
            </div>
           

            <div class="col-sm-4 form-group">
                <label for="email">Email</label>
                <input type="email" class="form-control" name="email" id="email" placeholder="Enter your email."  value="<?= $row['email'];?>">
            </div>

            <div class="col-sm-4 form-group">
                <label for="tel">Phone</label>
                <input type="tel" name="phone" class="form-control allownumericwithoutdecimal" maxlength="10" id="tel" placeholder="Enter Your Contact Number."  value="<?= $row['phone'];?>" >
            </div>
           
            <div class="col-sm-4 form-group">
                 <label >Gender</label><br>
                 <input type="radio" id="gender" name="gender" value="Male" <?php if($row['gender']=='Male'){ echo "checked";} ?>>
            <label for="gender">Male</label>
            <input type="radio" id="gender" name="gender" value="Female" <?php if($row['gender']=='Female'){ echo "checked";}?>>
            <label for="gender">Female</label>
            <input type="radio" id="gender" name="gender" value="Other" <?php if($row['gender']=='Other'){ echo "checked";} ?>>
            <label for="gender">Other</label>
            ...
            <div class="col-sm-4 form-group">
                ...
                <img src="images/profile/<?=$row['image'];?>" alt="profile" width="100" height="100">
                </div>
